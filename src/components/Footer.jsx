...
const Footer = () => {
    return (
        <>
            <footer className='poppins bg-slate-800 text-neutral-300 w-full h-full py-16 px-5'>
                        ...
                        <div className="text-center">
                            ...
                            <ul className='flex flex-col justify-start items-center gap-1 mt-5 text-[14px] sm:text-[17px]'>
                                ...
                                <li className='flex justify-start items-center gap-2 mt-5'>
                                    <span className='p-2 bg-yellow-600 text-neutral-100 hover:text-white rounded-lg hover:scale-110'><Icon icon="eva:google-fill" width="20" height="20"></Icon></span>
                                    ...
                                    <span className='p-2 bg-yellow-600 text-neutral-100 hover:text-white rounded-lg hover:scale-110'><Icon icon="bi:twitter" width="20" height="20"></Icon></span>
                                    <span className='p-2 bg-yellow-600 text-neutral-100 hover:text-white rounded-lg hover:scale-110'><Icon icon="ri:linkedin-fill" width="20" height="20"></Icon></span>
                                </li>
                            </ul>
                        </div>
